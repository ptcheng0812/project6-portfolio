...
export default function PagesCategoriesOthers() {
  ...
  return (
    <CompsLayout>
      <div id="pages-categories-others" className="pages-categories-show text-center">
        <h1>Other Mental Health Conditions</h1>
